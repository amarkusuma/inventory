        ...
        <div class="row justify-content-center">
          <div class="col-md-6">
            ...
            <div class="card card-outline-secondary">
              ...
              <form autocomplete="off" class="form" role="form" method="POST" action="{{route('store-pelanggan')}}">
                  @csrf
                  <div class="form-group">
                    <label for="nama">Nama Pelanggan</label> 
			          		<input class="form-control" name="nama_pelanggan" required="" type="text">
                  </div>

                  <div class="form-group">
                    <label for="harga">No Telfon</label> 
                    <input class="form-control" name="no_telfon" required="" type="number"> 
