          ...
          <div class="col-md-6">
            ...
            <div class="card card-outline-secondary">
              <div class="card-header">
                <h3 class="mb-0 text-center">Input Pelanggan</h3>
              </div>

              <div class="card-body">

              <form autocomplete="off" class="form" role="form" method="POST" action="{{route('update-pelanggan', $master_pelanggan->kode_pelanggan)}}">
                  @csrf
                  {{ method_field('PUT') }}

                  <div class="form-group">
                    <label for="nama">Nama Pelanggan</label> 
                    <input class="form-control" name="nama_pelanggan" required="" value="{{$master_pelanggan->nama_pelanggan}}" type="text">
                  </div>

                  <div class="form-group">
                    <label for="harga">No Telfon</label> 
                    <input class="form-control" name="no_telfon" required="" value="{{$master_pelanggan->no_telp_pelanggan}}" type="number"> 
                      ...
                      <div class="row mb-1">
                        <div class="col-lg-12">
                          <textarea class="form-control" name="alamat" required="" rows="3">
                            {{$master_pelanggan->alamat_pelanggan}}
                          </textarea>
                        </div>
                    </div>
                  </div>
