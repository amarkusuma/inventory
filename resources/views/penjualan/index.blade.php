            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="row">
                        <!-- Grid column -->
                        <div class="col-md-12">
                            <h2 class="py-3 text-center font-bold font-up blue-text">Table Transaksi Penjualan</h2>
                        </div>
                        <!-- Grid column -->
                    </div>
                    <!-- Grid row -->
                    
                 <form action="{{route('add-transaksi-penjualan')}}" method="post">
                    @csrf
                    <div class="input-transaksi-penjualan">
                    ...
                    <table class="table table-hover table-responsive mb-0">
                        ...
                        <tbody>
                            ...
                            <tr>
                                    ...
                                    <td>
                                        <a href="{{route('delete-transaksi-penjualan',$data->kode_penjualan ? $data->kode_penjualan : 0)}}" class="btn btn-danger btn-sm">Hapus</a>
                                        <a href="{{route('show-transaksi-penjualan', $data->kode_penjualan ? $data->kode_penjualan : 0)}}" class="btn btn-primary btn-sm">Update</a>
                                    </td>
...
$(document).ready(function(){
    ...
    $('.barang_id-field').on("change", function(e) {
            ...
            success:function(response) {
                ...
                const form = '.input-transaksi-penjualan' ;
    ...
    const today = () => {
        ...
        $('.input-transaksi-penjualan').find('input[name=date]').val(today);
    }
