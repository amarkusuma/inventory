            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="row">
                        <!-- Grid column -->
                        <div class="col-md-12">
                            <h2 class="py-3 text-center font-bold font-up blue-text">Update Transaksi Pembelian</h2>
                        </div>
                        <!-- Grid column -->
                    </div>
                    <!-- Grid row -->
                    
                 <form action="{{route('update-transaksi-pembelian', $transaksi_pembelian['kode_pembelian'])}}" method="post">
                    @csrf
                    <div class="show-transaksi-pembelian">
                        <div class="form-group">
                            <div class="col-sm-4">
                              <label >Tanggal</label>
                              <input type="date" class="form-control" name="date" value="{{$transaksi_pembelian['tanggal_pembelian']}}">
                        ...
                        <div class="form-group">
                            <div class="col-sm-4">
                              ...
                              <select class="supplier_id-field form-control" name="supplier_id" id="supplier_id" required>
                                <option value="{{$transaksi_pembelian['kode_supplier']}}" selected="selected">{{$transaksi_pembelian['nama_supplier']}}</option>       
                       ...
                       <div class="form-group">
                        <div class="row col-sm-12">
                                ...
                                <select class="barang_id-field form-control" name="barang_id" id="barang_id" required>
                                  <option value="{{$transaksi_pembelian['kode_barang']}}" selected="selected">{{$transaksi_pembelian['nama_barang']}}</option>       
                                </select>
                                <span class="form-highlight"></span>
                                <span class="form-bar"></span>
                                </div>
                            ...
                            {{-- <div class="form-group"> --}}
                                <div class="col-sm-4">
                                <label>Harga</label>
                                <input type="text" name="harga_satuan" class="form-control" value="{{$transaksi_pembelian['harga_satuan']}}" >
                                <span class="form-highlight"></span>
                                <span class="form-bar"></span>
                                </div>
                            {{-- </div> --}}
                            ...
                            {{-- <div class="form-group"> --}}
                                <div class="col-sm-2">
                                <label >Jumlah</label>
                                <input type="text" class="form-control" name="jumlah" value="{{$transaksi_pembelian['jumlah']}}">
                                <span class="form-highlight"></span>
                                <span class="form-bar"></span>
                                </div>
                            {{-- </div> --}}
...
$(document).ready(function(){
    ...
    $('.barang_id-field').on("change", function(e) {
            ...
            success:function(response) {
                ...
                const form = '.show-transaksi-pembelian' ;
    ...
    const today = () => {
        ...
        $('.show-transaksi-pembelian').find('input[name=date]').val(today);
    }
    ...
    // $('.show-transaksi-pembelian').find('select[name=supplier_id]').val('S001').trigger('change');
    // $('.show-transaksi-pembelian').find('select[name=supplier_id]').val("S001").trigger('change');
