        ...
        <div class="row justify-content-center">
          <div class="col-md-6">
            ...
            <div class="card card-outline-secondary">
              ...
              <form autocomplete="off" class="form" role="form" method="POST" action="{{route('update-barang', $master_barang->kode_barang)}}">
                  @csrf
                  {{ method_field('PUT') }}

                  <div class="form-group">
                    <label for="nama">Nama Barang</label> 
                    <input class="form-control" name="nama_barang" required="" type="text" value="{{$master_barang->nama_barang}}">
                  </div>
                  ...
                  <div class="form-group">
                    <label class="mb-0" for="message2">Deskripsi</label>
                      <div class="row mb-1">
                        <div class="col-lg-12">
                          <textarea class="form-control" name="deskripsi" required="" rows="3">
                  ...
                  <div class="form-group">
                    ...
                    <input class="form-control" name="harga" required="" type="number" value="{{$master_barang->harga_satuan}}"> 
                  ...
                  <div class="form-group">
                    ...
                    <input class="form-control" name="stok" required="" type="number" value="{{$master_barang->stok}}"> 
                    {{-- <small class="form-text text-muted" id="passwordHelpBlock">Your password must be 8-20 characters long, contain letters and numbers, and must not contain spaces, special characters, or emoji.</small> --}}
                  </div>
